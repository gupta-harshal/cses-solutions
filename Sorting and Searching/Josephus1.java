...
public class Josephus1 extends MyTemplate.Calc {
    static int[] bit;
    static int n;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            currPos = (currPos + 1) % remaining;
            int child = findKth(currPos + 1);

            sb.append(child).append(i == n - 1 ? "" : " ");

            update(child, -1);
            remaining--;
        }

        jio.println(sb.toString());
        jio.flush();
    }
}
/*end here--------------------*/
